import"./modulepreload-polyfill-B5Qt9EMX.js";import{r,j as e,c as y}from"./vendor-three-DWdYVK8p.js";import{u as b}from"./usePyodide-Bpngy5wJ.js";import"./vendor-react-CCYiWZgt.js";function j(){const c=r.useRef(null),[n,p]=r.useState(!1),l=r.useRef(!1),t=r.useRef(null),o=r.useRef(!1),{pyodide:s,isReady:i,error:d}=b(["moving_curve_new.py","mfs_hele_shaw_viscous_fingering.py"],{packages:["matplotlib"]}),u=r.useCallback(async()=>{if(!s||!i||!c.current)return;const a=document.querySelector('div[id^="matplotlib_"]');a&&a.remove(),c.current.innerHTML='<div class="loading-placeholder"><p>Initializing simulation...</p></div>',await s.runPythonAsync(`
import numpy as np
import js
