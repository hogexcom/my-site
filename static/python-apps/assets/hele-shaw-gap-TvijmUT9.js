import"./modulepreload-polyfill-B5Qt9EMX.js";import{r as i,j as e,aI as g,aJ as b}from"./vendor-three-DWdYVK8p.js";import{u as j}from"./usePyodide-Bpngy5wJ.js";import"./vendor-react-CCYiWZgt.js";function w(){const c=i.useRef(null),[n,u]=i.useState(!1),s=i.useRef(!1),t=i.useRef(null),o=i.useRef(!1),{pyodide:l,isReady:a,error:d}=j(["moving_curve_new.py","mfs_hele_shaw_gap.py"],{packages:["matplotlib"]}),p=i.useCallback(async()=>{if(!l||!a||!c.current)return;const r=document.querySelector('div[id^="matplotlib_"]');r&&r.remove(),c.current.innerHTML='<div class="loading-placeholder"><p>Initializing simulation...</p></div>',await l.runPythonAsync(`
import numpy as np
import js
