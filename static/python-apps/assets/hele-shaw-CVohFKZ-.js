import"./modulepreload-polyfill-B5Qt9EMX.js";import{r as a,j as e,c as b}from"./vendor-three-CePzC98V.js";import{u as w}from"./usePyodide-SVK5obCv.js";import"./vendor-react-CCYiWZgt.js";const j="/my-site/python-apps/";function S(){const p=a.useRef(null),[s,m]=a.useState(!1),l=a.useRef(!1),t=a.useRef(null),c=a.useRef(!1),{pyodide:i,isReady:r,error:_}=w(["moving_curve_new.py","mfs_hele_shaw.py"],{packages:["matplotlib"]}),u=a.useCallback(async()=>{if(!i||!r||!p.current)return;const y=await(await fetch(`${j}/pi_contour.npy`)).arrayBuffer(),d=new Uint8Array(y);i.FS.writeFile("/pi_contour.npy",d);const o=document.querySelector('div[id^="matplotlib_"]');o&&o.remove(),p.current.innerHTML='<div class="loading-placeholder"><p>Initializing simulation...</p></div>',await i.runPythonAsync(`
import numpy as np
import js
