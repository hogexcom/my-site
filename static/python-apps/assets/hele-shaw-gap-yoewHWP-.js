import"./modulepreload-polyfill-B5Qt9EMX.js";import{r as i,j as e,av as g,aw as b}from"./vendor-three-BnpV2lbo.js";import{u as w}from"./usePyodide-BJDiuWYS.js";import"./vendor-react-CCYiWZgt.js";function j(){const c=i.useRef(null),[n,u]=i.useState(!1),s=i.useRef(!1),t=i.useRef(null),o=i.useRef(!1),{pyodide:l,isReady:a,error:d}=w(["moving_curve_new.py","mfs_hele_shaw_gap.py"],{packages:["matplotlib"]}),p=i.useCallback(async()=>{if(!l||!a||!c.current)return;const r=document.querySelector('div[id^="matplotlib_"]');r&&r.remove(),c.current.innerHTML='<div class="loading-placeholder"><p>Initializing simulation...</p></div>',await l.runPythonAsync(`
import numpy as np
import js
...
update_plot()
fig.canvas.draw()
`)},[l,a]);i.useEffect(()=>{if(s.current=n,!n){t.current&&(cancelAnimationFrame(t.current),t.current=null);return}let r=0;const y=1e3/10,f=async h=>{s.current&&(h-r>=y&&(await m(),r=h),s.current&&(t.current=requestAnimationFrame(f)))};return t.current=requestAnimationFrame(f),()=>{t.current&&(cancelAnimationFrame(t.current),t.current=null)}},[n,m]),i.useEffect(()=>{a&&!o.current&&p()},[a,p]);const v=()=>u(!0),_=()=>{u(!1),s.current=!1,t.current&&(cancelAnimationFrame(t.current),t.current=null)},x=async()=>{_(),o.current=!1;const r=document.querySelector('div[id^="matplotlib_"]');r&&r.remove(),await p()};return e.jsxs("div",{className:"app-container",children:[e.jsxs("header",{className:"app-header",children:[e.jsx("h1",{children:"🫧 Hele-Shaw Gap Rising Flow"}),e.jsx("p",{className:"subtitle",children:"基本解近似解法（MFS）による隙間上昇ヘレショウ流れ"})]}),d&&e.jsxs("div",{className:"error-message",children:["Error: ",d]}),e.jsx("div",{className:"figure-wrapper",ref:c,children:!a&&e.jsx("div",{className:"loading-placeholder",children:e.jsx("p",{children:"Loading Python & Matplotlib..."})})}),e.jsxs("div",{className:"controls",children:[e.jsxs("div",{className:"buttons",children:[n?e.jsx("button",{className:"btn btn-warning",onClick:_,children:"⏸ 停止"}):e.jsx("button",{className:"btn btn-success",onClick:v,disabled:!a,children:"▶ 再生"}),e.jsx("button",{className:"btn btn-secondary",onClick:x,disabled:!a,children:"🔄 Restart"})]}),!a&&e.jsx("p",{className:"loading-text",children:"Loading Python environment..."})]}),e.jsx("footer",{className:"app-footer",children:e.jsx("p",{children:e.jsx("a",{href:"/my-site/python-apps/",children:"← Back to Apps"})})})]})}g.createRoot(document.getElementById("root")).render(e.jsx(b.StrictMode,{children:e.jsx(j,{})}));
